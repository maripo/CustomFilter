...
var RuleEditorDialog = function(rule, src, _zIndex, ruleEditor) 
{
	...
	RuleEditor.displaySiteExpressionMatchResult = function () {
		var regex;
	...
	document.getElementById('rule_editor_site_regexp')
		.addEventListener('keyup', RuleEditor.displaySiteExpressionMatchResult, false);
...
RuleEditorDialog.prototype.getChangedAction = function ()
{
	...
	return function (sender)
	{
		...
		RuleEditor.displaySiteExpressionMatchResult();
	}
};
