 ...
 */
 class SmartRuleCreator {
 	constructor (targetElement, appliedRuleList, selectionText, needSuggestion)
	{
...
class SmartRuleCreatorDialog {
	...
	/* UI */
	radio_search_css:HTMLElement;
	radio_search_xpath:HTMLElement;
	radio_hide_css:HTMLElement;
	/* Dragging */
	moving:boolean;
	origEventX:number;
	origEventY:number;
